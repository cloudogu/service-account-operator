...
func (_m *mockServiceAccountClient) Create(ctx context.Context, consumer string, params internalproducer.Params) (map[string]string, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, internalproducer.Params) (map[string]string, error)); ok {
		return rf(ctx, consumer, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, internalproducer.Params) map[string]string); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, internalproducer.Params) error); ok {
...
//   - ctx context.Context
//   - consumer string
//   - params internalproducer.Params
...
func (_c *mockServiceAccountClient_Create_Call) Run(run func(ctx context.Context, consumer string, params internalproducer.Params)) *mockServiceAccountClient_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(internalproducer.Params))
	})
	return _c
}
...
func (_c *mockServiceAccountClient_Create_Call) RunAndReturn(run func(context.Context, string, internalproducer.Params) (map[string]string, error)) *mockServiceAccountClient_Create_Call {
	_c.Call.Return(run)
	return _c
}

// CreateOrUpdate provides a mock function with given fields: ctx, consumer, params, behaviorParams
func (_m *mockServiceAccountClient) CreateOrUpdate(ctx context.Context, consumer string, params internalproducer.Params, behaviorParams internalproducer.BehaviorParams) (map[string]string, error) {
	...
	var r0 map[string]string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, internalproducer.Params, internalproducer.BehaviorParams) (map[string]string, error)); ok {
		return rf(ctx, consumer, params, behaviorParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, internalproducer.Params, internalproducer.BehaviorParams) map[string]string); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, internalproducer.Params, internalproducer.BehaviorParams) error); ok {
...
//   - consumer string
//   - params internalproducer.Params
//   - behaviorParams internalproducer.BehaviorParams
...
func (_c *mockServiceAccountClient_CreateOrUpdate_Call) Run(run func(ctx context.Context, consumer string, params internalproducer.Params, behaviorParams internalproducer.BehaviorParams)) *mockServiceAccountClient_CreateOrUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(internalproducer.Params), args[3].(internalproducer.BehaviorParams))
	})
	return _c
}
...
func (_c *mockServiceAccountClient_CreateOrUpdate_Call) RunAndReturn(run func(context.Context, string, internalproducer.Params, internalproducer.BehaviorParams) (map[string]string, error)) *mockServiceAccountClient_CreateOrUpdate_Call {
	_c.Call.Return(run)
	return _c
}
