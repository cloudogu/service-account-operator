...
func (_c *mockServiceAccountClient_Update_Call) Run(run func(ctx context.Context, consumer string, params internalproducer.Params)) *mockServiceAccountClient_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(internalproducer.Params))
	})
	return _c
...
func (_c *mockServiceAccountClient_Update_Call) RunAndReturn(run func(context.Context, string, internalproducer.Params) (map[string]string, error)) *mockServiceAccountClient_Update_Call {
	_c.Call.Return(run)
	return _c
}
