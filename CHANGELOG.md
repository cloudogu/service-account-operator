...
## [Unreleased]
### Added
- `manager.extraEnv` in values.yaml to allow setting extra environment variables for the manager container
  - This is useful for setting e.g., a timezone variable
